...
import SliderFlight from '../components/SliderFlight';
...
import Footer from './Footer/Footer';
 ...
 export default function Flights() {
   ...
   return (
     <div>
      <SliderFlight/>
      <div className="flex mb-4  pb-4 justify-center items-center">
      ...
      <div className='max-w-6xl mx-auto pt-4 space-y-6' >
       ...
       {filteredDataNational && filteredDataNational.length >0 && (
          <div className='m-2 mb-6 '>
            ...
            <Link to="/categoryflight/national">
              <p className='px-3 text-sm text-blue-500 
       ...
       {filteredDataInter && filteredDataInter.length >0 && (
          <div className='m-2 mb-6 '>
            ...
            <Link to="/categoryflight/international">
              <p className='px-3 text-sm text-blue-500 
